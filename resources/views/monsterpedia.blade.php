<x-app-layout>
    <div class="flex bg-gray-900 min-h-screen">
        ...
        <div class="flex-1 ml-72 p-8">
            <!-- Monsterpedia Content -->
            <div class="content-section active">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-3xl font-bold text-white">Monsterpedia</h2>
                ...
                <!-- Search Bar -->
                <div class="mb-8">
                    <form method="GET" action="{{ route('monsterpedia') }}">
                        <div class="relative">
                            <input type="text" name="search" value="{{ request('search') }}" id="monster-search" placeholder="Search monsters..." class="w-full bg-gray-800 text-white rounded-lg py-3 px-4 pl-10 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                ...
                <div class="flex space-x-4 mb-6 border-b border-gray-700 pb-2">
                    <a href="{{ route('monsterpedia') }}" class="{{ request('category') == null ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white' }} px-4 py-2 rounded-t-lg font-medium">All Monsters</a>
                    <a href="{{ route('monsterpedia', ['category' => 'Aquatic']) }}" class="{{ request('category') == 'Aquatic' ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white' }} px-4 py-2 font-medium">Aquatic</a>
                    <a href="{{ route('monsterpedia', ['category' => 'Terrestrial']) }}" class="{{ request('category') == 'Terrestrial' ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white' }} px-4 py-2 font-medium">Terrestrial</a>
                    <a href="{{ route('monsterpedia', ['category' => 'Aerial']) }}" class="{{ request('category') == 'Aerial' ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white' }} px-4 py-2 font-medium">Aerial</a>
                    <a href="{{ route('monsterpedia', ['category' => 'Paranormal']) }}" class="{{ request('category') == 'Paranormal' ? 'text-white bg-gray-700' : 'text-gray-400 hover:text-white' }} px-4 py-2 font-medium">Paranormal</a>
                </div>
