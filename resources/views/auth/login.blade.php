<x-guest-layout>
    ...
    <div class="monster-login-wrapper">
        <!-- New Left Side Image Container -->
        <div class="login-image-container">
            <img src="{{ asset('background.png') }}" alt="Login Background" class="login-side-image" />
            <div class="image-overlay">
                <h2 class="overlay-title">Welcome Back!</h2>
                <p class="overlay-text">Access your Monster App account and continue your journey.</p>
            </div>
        </div>
        ...
        <div class="monster-login-container">
            <form method="POST" action="{{ route('login') }}" class="login-form">
                ...
                <h1 class="login-title">Log in to Monster App</h1>
                ...
                <div class="input-group">
                    ...
                    <x-text-input id="email" class="monster-input" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Your Email" />
                </div>
                ...
                <div class="input-group">
                    ...
                    <x-text-input id="password" class="monster-input" type="password" name="password" required autocomplete="current-password" placeholder="Password" />
                </div>
                <x-input-error :messages="$errors->get('password')" class="error-message" />

                <!-- Remember Me -->
                <div class="remember-container">
                    <label for="remember_me" class="monster-checkbox">
                ...
                <div class="links-container">
                    @if (Route::has('password.request'))
                        <a class="monster-link" href="{{ route('password.request') }}">
                            {{ __('Forgot password?') }}
                        </a>
                    @endif

                    <a class="monster-link" href="{{ route('register') }}">
                        {{ __('Register') }}
                    </a>
                </div>
            </form>
    ...
    <style>
        ...
        /* New wrapper for the split layout */
        ...
        /* New container for the side image */
        ...
        .monster-checkbox:hover .checkmark {
            border-color: var(--primary-color);
        }
        
        .monster-checkbox input:checked ~ .checkmark {
        ...
        .monster-checkbox input:checked ~ .checkmark:after {
            display: block;
        }
